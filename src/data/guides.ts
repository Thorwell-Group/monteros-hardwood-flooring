...
Want to feel the difference? We bring [laminate](/services/laminate-flooring/) and [luxury vinyl plank](/services/luxury-vinyl-plank/) samples side-by-side. [Book a free in-home estimate](/free-estimate/).`,
  ...
  },
  {
    ...
    metaTitle: 'Engineered vs Solid Hardwood for Slab Homes',
    metaDesc: 'Most Inland Empire homes sit on a concrete slab, and that single fact decides which hardwood belongs in yours. A contractor explains the choice.',
