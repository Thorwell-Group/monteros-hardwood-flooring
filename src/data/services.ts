...
export const services: Service[] = [
  {
    ...
    heroImage: '/images/hardwood-flooring-installation.webp',
    altText: 'Newly installed wide-plank hardwood floor in a Southern California home',
    priceFromUSD: 8,
    priceToUSD: 16,
  ...
  },
  {
    ...
    heroImage: '/images/hardwood-floor-refinishing.webp',
    altText: 'Hardwood floor mid-refinishing showing freshly sanded wood ready for stain',
    priceFromUSD: 3,
    priceToUSD: 7,
  ...
  },
  {
    ...
    heroImage: '/images/luxury-vinyl-plank-flooring.webp',
    altText: 'Luxury vinyl plank flooring in a bright Southern California living room',
    priceFromUSD: 4,
    priceToUSD: 9,
  ...
  },
  {
    ...
    heroImage: '/images/laminate-flooring.webp',
    altText: 'Laminate wood-look flooring installed in a Southern California living room',
    priceFromUSD: 3,
    priceToUSD: 7,
    timeline: '1 – 3 days for most homes',
    cityVariant: true,
  ...
  },
  {
    ...
    heroImage: '/images/hardwood-staircase-installation.webp',
    altText: 'Newly installed hardwood staircase with matching treads and risers',
    priceFromUSD: 80,
    priceToUSD: 200,
